...
<template>
    <section id="pricing" class="relative overflow-hidden bg-white py-24 sm:py-32">
        ...
        <div class="pointer-events-none absolute inset-0 flex items-start justify-center">
            <div class="h-[600px] w-[800px] rounded-full bg-primary-100/60 blur-3xl" />
        </div>
        ...
        <div class="relative mx-auto max-w-7xl px-6">
            ...
            <div class="mx-auto mb-14 max-w-2xl text-center" data-price-animate>
                <p class="mb-3 text-xs font-semibold uppercase tracking-widest text-primary-600">Pricing</p>
                ...
                <div class="mt-8 inline-flex items-center gap-1 rounded-xl border border-gray-200 bg-gray-100 p-1 shadow-inner">
                    ...
                    >
                        Annual
                        <span class="rounded-full bg-success-100 px-2 py-0.5 text-xs font-bold text-success-700">
                            Save ${{ annualSaving }}
                        </span>
                    </button>
                </div>
            ...
            <div class="grid items-end gap-6 lg:grid-cols-3">
                ...
                <div
                    ...
                    :class="plan.highlight
                        ? 'bg-gradient-primary text-white shadow-2xl shadow-primary-900/40 ring-2 ring-primary-400 lg:-translate-y-4'
                ...
                >
                    ...
                    <div v-if="plan.badge" class="absolute -top-4 inset-x-0 flex justify-center">
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-gradient-accent px-4 py-1 text-xs font-bold text-white shadow-md shadow-accent-900/30">
                    ...
                    <div class="p-8 pb-6">
                        ...
                        <div class="mb-5 flex items-center gap-3">
                            <div
                                ...
                                :class="plan.highlight ? 'bg-white/15' : 'bg-primary-50'"
                            >
                                <component
                                    :is="plan.icon"
                                    class="size-5"
                                    :class="plan.highlight ? 'text-white' : 'text-primary-600'"
                                />
                            </div>
                            <span
                                class="text-sm font-bold uppercase tracking-widest"
                                :class="plan.highlight ? 'text-primary-200' : 'text-gray-500'"
                            >{{ plan.name }}</span>
                        </div>
                        ...
                        <div class="flex items-end gap-1.5">
                            ...
                            <span
                                ...
                                :class="plan.highlight ? 'text-primary-200' : 'text-gray-400'"
                        ...
                        <div
                            class="mt-6 border-t"
                            :class="plan.highlight ? 'border-primary-500/50' : 'border-gray-100'"
                        />
                    </div>
                    ...
                    <ul class="flex-1 space-y-3 px-8 pb-8">
                        ...
                        >
                            <CheckCircleIcon
                                ...
                                :class="plan.highlight ? 'text-primary-200' : 'text-success-500'"
                            />
                            <MinusIcon
                                v-else
                                class="mt-0.5 size-5 shrink-0"
                                :class="plan.highlight ? 'text-primary-400/60' : 'text-gray-300'"
                            />
                            <span :class="[
                                feature.included
                                    ? (plan.highlight ? 'text-primary-100' : 'text-gray-700')
                                    : (plan.highlight ? 'text-primary-300/60' : 'text-gray-400'),
                            ]">{{ feature.text }}</span>
                        </li>
                    </ul>
                    ...
                    <div class="px-8 pb-8">
                        <component
                            ...
                            :class="plan.highlight
                                ? 'bg-white text-primary-700 hover:bg-primary-50 hover:shadow-lg active:scale-[0.98]'
                                : plan.id === 'enterprise'
                                    ? 'border-2 border-gray-300 bg-white text-gray-700 hover:border-primary-400 hover:text-primary-600 hover:shadow-md'
                        ...
                        <p
                            ...
                            :class="plan.highlight ? 'text-primary-300' : 'text-gray-400'"
                        >
            ...
            <div class="mt-16 text-center" data-price-animate style="transition-delay: 320ms">
                <p class="text-sm text-gray-500">
                    ...
                    <a href="#faq" class="font-medium text-primary-600 hover:underline">Have questions? See our FAQ →</a>
                </p>
            </div>
